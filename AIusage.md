...
- **Výsledek:** AI (Claude Opus 4.6) mi pomohlo napsat logiku pro generování metrik jako `doubled_pawns`, `king_shield`, `extended_center_control` a integraci knihovny `python-chess` ke zjišťování ohrožených políček. Výrazně se tím zvedla přesnost.
